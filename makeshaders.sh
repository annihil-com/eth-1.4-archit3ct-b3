...
# Transparent flat shader
transflatShaderSkel() {
	echo "$NAME
	{
		deformVertexes wave 100 sin $SIZE 0 1 0
		{
			map $MAP.tga
			blendfunc GL_ONE GL_ONE
			rgbgen wave inversesawtooth 0.2 1 .2 .5
		}
	}"
}
TRANSFLAT_SHADERS="
	transflatBlueShader:0:gfx/colors/blue:GFX_BLUE
	transflatCyanShader:0:gfx/colors/cyan:GFX_CYAN
	transflatGreenShader:0:gfx/colors/green:GFX_GREEN
	transflatRedShader:0:gfx/colors/red:GFX_RED
	transflatTealShader:0:gfx/colors/teal:GFX_TEAL
	transflatYellowShader:0:gfx/colors/yellow:GFX_YELLOW
"
makeShader "$TRANSFLAT_SHADERS" transflatShaderSkel CHAM_TRANSFLAT

# Ghost shader
ghostShaderSkel() {
	echo "$NAME
	{
		deformVertexes wave 999 sin $SIZE 0 1 0
		{
			map $MAP.tga
			blendfunc GL_ONE GL_ONE
			rgbgen wave inversesawtooth 0 0 .0 .5
		}
	}"
}

GHOST_SHADERS="
	ghostBlueShader:0:gfx/colors/blue:GFX_BLUE
	ghostCyanShader:0:gfx/colors/cyan:GFX_CYAN
	ghostGreenShader:0:gfx/colors/green:GFX_GREEN
	ghostRedShader:0:gfx/colors/red:GFX_RED
	ghostTealShader:0:gfx/colors/teal:GFX_TEAL
	ghostYellowShader:0:gfx/colors/yellow:GFX_YELLOW
"
makeShader "$GHOST_SHADERS" ghostShaderSkel CHAM_GHOST

# Plasma shader
plasmaShaderSkel() {
	echo "$NAME
	{
		deformVertexes wave 1 sin $SIZE 0 1 0
		{
			map $MAP.tga
			blendfunc GL_ONE GL_ONE
			rgbgen wave square 0.99 0.0 0 2.3
			tcGen environment
		}
	}"
}
PLASMA_SHADERS="
	plasmaBlueShader:0:gfx/effects/plasmablue:GFX_BLUE
	plasmaCyanShader:0:gfx/effects/plasmacyan:GFX_CYAN
	plasmaGreenShader:0:gfx/effects/plasmagreen:GFX_GREEN
	plasmaRedShader:0:gfx/effects/plasmared:GFX_RED
	plasmaTealShader:0:gfx/effects/plasmateal:GFX_TEAL
	plasmaYellowShader:0:gfx/effects/plasmayellow:GFX_YELLOW
"
makeShader "$PLASMA_SHADERS" plasmaShaderSkel CHAM_PLASMA
...
MENU_SHADERS="
	intro:gfx/menu/intro:CAT_INTRO
	menu:gfx/menu/menu:CAT_MENU
