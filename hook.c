...
//bizarre
/**I know there is a better place to put this but i'm just testing  */
	...
	switch (command) {
		case CG_INIT: {
			...
			if (!windowsinitialized)
			  {
			    initWindow("radar3", 640, 0, 0, 0, 0.16f, 0.2f, 0.17f, 0.8f);
			    ...
			    initWindow("refwin", 10, 250, 0, 0, 0.16f, 0.2f, 0.17f, 0.8f);
